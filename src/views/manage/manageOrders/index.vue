    ...
    <el-table v-loading="loading" :data="manageOrdersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link type="primary" icon="Stamp" @click="handleGetComment(scope.row)" v-hasPermi="['manage:manageOrders:query']">查看订单评价</el-button>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="manageOrdersRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="成人数" prop="adultCount">
          <el-input v-model="form.adultCount" placeholder="请输入成人数" />
        </el-form-item>
        <el-form-item label="儿童数" prop="childCount">
          <el-input v-model="form.childCount" placeholder="请输入儿童数" />
        </el-form-item>
...
function handleGetComment(row) {
  ...
  proxy.$router.push({ path: '/feedback/reviewsManage', query: { orderId: _orderId } });
}
